...
async function saveTask() {
    ...
    try {
        ...
        if (isEdit) {
            ...
            await createNewTasksForAllUsers(); // Updated function name
        }
...
async function createNewTasksForAllUsers() {
    ...
    try {
        // Process in smaller batches for better reliability with large numbers
        const batchSize = 20; // Reduced batch size for 400+ users
        ...
        for (let i = 0; i < tasksToCreate.length; i += batchSize) {
            ...
            try {
                ...
                // Handle both successful and failed records
        ...
        // Remove progress notification on error
